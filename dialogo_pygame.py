...
DIALOGO_TERREO_INICIO = [
    ...
    ("Player", "Tenho que me formar logo pra ser efetivado(a)!!"),
    ("NPC", "Rapaz, boa sorte, pois eu não faço ideia de como fazer isso!"),
    ("Player", "Bem, como um(a) jogador(a) de RPG, eu diria que o prédio virou uma espécie de masmorra, conhecida como 'dungeon'. Se eu derrotar os monstros e fechar o portal. Provavelmente vai tudo voltar ao normal!"),
]

DIALOGO_INTRO_MESTRE = [
    ("Mestre Cleyton", "Jovem herói/heroína, finalmente nos encontramos. Eu sou Cleyton. Eu sou um Guia Dimensional. O que você viu é a materialização do Cáos Curricular."),
    ("Mestre Cleyton", "O CEAGRI, seu templo de conhecimento, agora é uma Masmorra Acadêmica. Sua missão é simples: Você deve derrotar as quatro Entidades e, com a essência de cada uma, fechar o Portal do Jubilamento, antes que o Cáos se espalhe para o mundo exterior."),
...
DIALOGO_NIVEL_1_CHEFE = [
    ("Goblin da Adm.", "HAH! Mais um calouro perdido na burocracia eterna! Você será um escravo da papelada, como todos nós!"),
    ("Player", "Calouro é a sua avó, seu duende da papelada! Eu vim aqui para desburocratizar essa bagunça! Eu só quero meu diploma!"),
    ("Goblin da Adm.", "Acha que é fácil? Já preencheu o formulário 38-B para solicitação de diploma? Você nunca passará por mim sem uma assinatura e três cópias autenticadas! Muahahah!"),
    ("Player", "Não mesmo! Prepare-se para ser arquivado no lixo da história, seu mestre da papelada!"),
]
...
DIALOGO_NIVEL_2_CHEFE = [
    ("Robô Natureza", "Invasor. Seu carbono footprint está muito alto. Humanidade é um vírus. Este andar será o primeiro estágio."),
    ("Player", "Olha, eu apoio a sustentabilidade, juro! Eu separo meu lixo e uso ecobag! Mas transformar o prédio em uma selva não vai me impedir de terminar o TCC!"),
    ("Robô Natureza", "Insuficiente. Seu 'TCC' é uma manifestação da exploração dos recursos. Mais papel. Você será compostado, elemento disruptivo!"),
    ("Player", "Reciclado é o seu conceito de justiça ambiental! Eu vou mostrar a você o verdadeiro poder de um humano que quer se formar!"),
]
...
DIALOGO_NIVEL_3_CHEFE = [
    ("Mago Místico", "Mais um que ousa desafia a Lógica Inerente. Você busca o caos na Ordem Perfeita dos Grafos?"),
...
DIALOGO_NIVEL_4_CHEFE = [
    ...
    ("Player", "Então você é o chefão, hein? O Guardião do Código que está por trás de toda essa bagunça!"),
    ("Robô Python", "Error: Argumento inválido. Não sou \"chefão\". Sou a Arquitetura Principal. Sua presença causa conflito de recursos."),
    ("Player", "Um script com erros? Eu sou o aluno que vai te desinstalar! Você não possui as bibliotecas necessárias para me derrotar!"),
    ("Robô Python", "Minha lógica é impecável. Você não possui as bibliotecas necessárias para me derrotar. Import 'derrota' as 'sua_derrota'."),
    ("Player", "Pode ser que eu não tenha todas as bibliotecas, mas eu tenho a determinação de um estudante que não quer ser jubilado! Prepare-se para um *traceback* que você nunca vai esquecer!"),
]

DIALOGO_CONCLUSAO = [
    ("Mestre Cleyton", "Você conseguiu! Você superou o Cáos Curricular!"),
    ...
    ("Player", "Eu consegui! Estou formado(a)! Efetivação, lá vou eu!"),
    ("Mestre Cleyton", "Lembre-se, jovem herói/heroína, o verdadeiro poder está em não desistir da sua formação. Agora vá. Sua jornada acadêmica terminou."),
]
...
class CaixaDialogo:
    ...
    def desenhar(self):
        ...
        if self.bg_img:
            ...
            # Se falando com NPC e há imagem contextual, usar ela
...
def dialogo_terreo():
    ...
    npc_img = os.path.join(base, 'Imagens_dialogos', '68018f59-6c1f-4b19-9b7d-d01563003995.jpg')
